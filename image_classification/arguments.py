...
def get_args(description, mode='train'):
    ...
    if mode == 'train':
        parser.add_argument('-m', '--model', choices = ['resnet10', 'resnet14', 'resnet18', 'resnet20', 'resnet26', \
                            'resnet34', 'resnet34_0', 'resnet34_1', 'resnet34_2', 'resnet50', 'resnet101', 'resnet152', 'vit', 'mobilenet'], \
        ...
        parser.add_argument('-bs', '--batch_size', type=int, help = 'Batch size. default is 64', default=64)
