...
def epoch_train(student, teachers_list, data, sf_teacher, sf_student, loss_function, loss_function2, optimizer, hyper_params, epoch, savename, best_val_acc, expt=None, num_epochs_training_separately=0):
    now = datetime.now()
